...
// contains app title, role selector and dark mode toggle
// uses layout context to adapt to dark mode and toggle sidebar visibility
...
const Header = () => {
    ...
    return (
        <div
            className={`dashboard-layout d-flex justify-content-between align-items-center shadow-sm px-4 py-2 
                ${darkMode
                    ? "bg-dark text-light border-bottom border-secondary"
                    : " text-dark border-bottom"
                }`}
        >
